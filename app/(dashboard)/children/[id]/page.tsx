    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-200 transition-colors"
          >
      ...
      <div className="mb-8">
        ...
        >
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-1">Upload New Test</h3>
          <p className="text-sm text-gray-600">
            Upload a test for {child.name} to get AI-powered analysis
          </p>
        </Link>
      </div>
